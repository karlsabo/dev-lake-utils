 ...
 */
fun Issue.toProjectMilestone(): ProjectMilestone = ProjectMilestone(
    id = key,
    name = fields.summary,
    description = fields.description.toPlainText(),
 ...
 */
fun StatusCategory.toProjectStatusCategory(): UnifiedStatusCategory? = when (this.key?.lowercase()) {
