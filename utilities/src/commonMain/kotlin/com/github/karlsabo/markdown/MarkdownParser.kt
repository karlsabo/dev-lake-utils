...
object MarkdownParser {
     ...
     */
    fun getExtensionForImageType(imageType: String): String = EXTENSION_MAP[imageType] ?: imageType
     ...
     */
    fun urlEncodeImagePaths(content: String): String = IMAGE_LINK_PATTERN.replace(content) { matchResult ->
        val altText = matchResult.groupValues[1]
    ...
    private fun urlEncodePath(path: String): String = path.split("/").joinToString("/") { segment ->
